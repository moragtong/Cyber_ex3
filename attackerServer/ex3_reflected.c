...
/**
 * Receives an HTTP header terminated by a double CRLF,
 * and then uses the Content-Length field to receive the rest of
 * the response's body, and writes it to the file.
 */
